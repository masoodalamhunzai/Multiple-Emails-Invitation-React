            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              <Form.Row>
                ...
                <div className="add-inputs">
                  <Button variant="link"  className="link" btnText="add another" />
                  <Button variant="link" className="link" btnText="add many at once" />
                </div>
                <div className="send-invite">
                  <Button variant="secondary" className="link" btnText="Send Invites" />
                </div>
              </Form.Row>
            </Form>
          </Col>
